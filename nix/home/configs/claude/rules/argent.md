---
description: Argent iOS Simulator and Android Emulator Agent — guidance for methodology and tools for working with, interacting, testing and profiling mobile app work
paths:
  - "ios/**"
  - "android/**"
  - "vega/**"
